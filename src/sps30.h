...
struct sps_values {
    float   MassPM1;        // Mass Concentration PM1.0 [Î¼g/m3]
    float   MassPM2;        // Mass Concentration PM2.5 [Î¼g/m3]
    float   MassPM4;        // Mass Concentration PM4.0 [Î¼g/m3]
    float   MassPM10;       // Mass Concentration PM10 [Î¼g/m3]
    ...
    float   PartSize;       // Typical Particle Size [Î¼m]
};
